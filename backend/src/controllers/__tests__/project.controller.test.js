...
describe('Project Controller', () => {
  ...
  describe('createProject', () => {
    ...
    it('should trim project name', async () => {
      ...
      expect(res.statusCode).toBe(201);
      expect(res.jsonData.name).toBe('Test Project');
    });
  });
  ...
  describe('getProjectById', () => {
    it('should return project details with members and tasks', async () => {
      ...
      req.params.id = project.id.toString();
    ...
    it('should return 404 if project does not exist', async () => {
      ...
      expect(res.statusCode).toBe(403); // Will be 403 because user is not a member
    });
  });
  ...
  describe('addProjectMember', () => {
    ...
    it('should allow adding member with Admin role', async () => {
      // Create project
      const project = await prisma.project.create({
        data: {
          name: 'Test Project',
      ...
      expect(res.statusCode).toBe(201);
      expect(res.jsonData.role).toBe('Admin');
  ...
  describe('removeProjectMember', () => {
    it('should remove a member from a project and unassign their tasks', async () => {
      ...
      req.params.id = project.id.toString();
      req.params.userId = testUser2.id.toString();
    ...
    it('should return 403 when attempting to remove project creator', async () => {
      ...
      req.params.id = project.id.toString();
      req.params.userId = testUser1.id.toString();
    ...
    it('should only unassign tasks from the specific project', async () => {
      ...
      req.params.id = project1.id.toString();
      req.params.userId = testUser2.id.toString();
